  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-actions">
        <a
          href="https://github.com/jamesgarner-me/redactyl"
          target="_blank"
          rel="noopener noreferrer"
          className="icon-button"
          aria-label="View source on GitHub"
        >
          {/* Official GitHub Invertocat mark, inlined so it recolors with the
              theme via currentColor — swapping an <img src> per theme forced a
              re-decode/flash on every toggle. */}
          <svg width={16} height={16} viewBox="0 0 98 96" fill="none" aria-hidden="true">
            <g clipPath="url(#gh-invertocat)">
              <path
            ...
            <defs>
              <clipPath id="gh-invertocat">
                <rect width={98} height={96} fill="#fff" />
              </clipPath>
            </defs>
          </svg>
        </a>
